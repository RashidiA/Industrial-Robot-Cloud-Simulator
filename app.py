...
ROBOT_REGISTRY = {
    ...
    "Yaskawa_3500": {
        "links": [
            {"name": "A1", "trans": [0.0, 0.0, 0.70],   "rot": [0, 0, 1]},
            {"name": "A2", "trans": [0.30, 0.0, 0.0],   "rot": [0, 1, 0]},
            {"name": "A3", "trans": [0.0, 0.0, 1.15],   "rot": [0, 1, 0]},
            {"name": "A4", "trans": [1.10, 0.0, 0.15],  "rot": [1, 0, 0]},
            {"name": "A5", "trans": [0.18, 0.0, 0.0],   "rot": [0, 1, 0]},
            {"name": "A6", "trans": [0.18, 0.0, 0.0],   "rot": [1, 0, 0]},
        ],
